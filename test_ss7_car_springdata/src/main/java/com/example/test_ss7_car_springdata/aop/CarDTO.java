package com.example.test_ss7_car_springdata.aop;
...
@Component
public class CarDTO {
    @Before(" execution(* com.example.test_ss7_car_springdata.controller.CarController.*(..))")
//    @After(" execution(* com.example.demo_aop.controller.StudentController.showList(..))")
    ...
    @After(" execution(* com.example.test_ss7_car_springdata.controller.CarController.*(..))")
//    @After(" execution(* com.example.demo_aop.controller.StudentController.showList(..))")
