package com.example.demo_thi.controller;

import com.example.demo_thi.dto.QuestionContentDto;
import com.example.demo_thi.model.QuestionContent;
import com.example.demo_thi.model.QuestionType;
import com.example.demo_thi.service.IQuestionService;
import com.example.demo_thi.service.IQuestionTypeService;
...
public class QuestionController {
    ...
    public String getQuestionTypeDetails(@RequestParam Long idQuestionType, Model model) {
        QuestionType questionType = iQuestionTypeService.listQuestionType(idQuestionType);
