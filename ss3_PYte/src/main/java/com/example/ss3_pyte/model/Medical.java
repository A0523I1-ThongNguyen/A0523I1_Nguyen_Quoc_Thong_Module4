package com.example.ss3_pyte.model;
...
public class Medical {
    ...
    private String cmnd;
    private String vihacle;
    private String vihacleNumber;
    ...
    public String getVihacle() {
        return vihacle;
    }

    public void setVihacle(String vihacle) {
        this.vihacle = vihacle;
    }

    public String getVihacleNumber() {
        return vihacleNumber;
    }

    public void setVihacleNumber(String vihacleNumber) {
        this.vihacleNumber = vihacleNumber;
    }
