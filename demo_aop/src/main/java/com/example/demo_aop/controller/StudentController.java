...
import com.example.demo_aop.model.StudentDTO;
import com.example.demo_aop.service.codegym_class.ICodegymClassService;
import com.example.demo_aop.service.student.IStudentService;
import com.example.demo_aop.utils.NotFoundClassException;
...
//    }
    ...
    public String addNewStudent(@Valid @ModelAttribute("student") StudentDTO student,
        ...
        CodegymClass codegymClass = iCodegymClassService.findById(3L);
